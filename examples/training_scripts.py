...
class OdeDecGrudEnc():
    def run(self, mode, fresh_train='yes', ode_type='standard'):
...
if __name__ == '__main__':
    if args.method == 'grud':
        GrudEncDec().run(args.mode, args.fresh_train)
    elif args.method == 'ode':
        OdeDecGrudEnc().run(args.mode, args.fresh_train, args.ode)
    else:
        raise ValueError
